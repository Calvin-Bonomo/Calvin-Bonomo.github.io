...
export default function Home() {
  return (
      <div>
        <div className="p-7 grid gap-x-5 md:grid-cols-2 md:p-25">
            <h1 className="font-bold text-4xl text-center pb-4 md:text-5xl md:pb-0 md:text-start">Hi, I'm Calvin!</h1>
            ...
            <p className="pt-4 md:pt-0">I'm a fourth year undergraduate student at the University of Colorado Boulder, pursuing a Bachelor of Science in Computer Science at the University of Colorado Boulder. I previously interned at Apple on the visionOS UI and Frameworks team where I did prototyping and exploratory work as well as learning about API development.</p>
        </div>
        <div className="grid grid-rows-3 md:grid-rows-1 md:grid-cols-3 gap-10 p-10 place-items-center inset-shadow-[0px_8px_5px_rgba(0,0,0,0.1),0px_-8px_5px_rgba(0,0,0,0.1)]"> {/*Projects*/}
